...
function Input_Decimal(dot) {
  //This ensures that occidental clicking of the decimal point doesn't
...
function Handle_Operator(Next_Operator) {
  ...
  //Checks if an operator already exisst and if Wait_Second_operand is true,
  ...
  if (First_Operand == null) {
    ...
    //Here we add a fixed amount of numbers adter the decimal.
