...
//placement sount('./img/media/place.mp3')
function audio(audioUrl) {
  //We create a new audio boject and we pass the path as a parameter
...
function computersTurn() {
  ...
  let pickASquare;
  while (!success) {
    //Arandom number between 0 and 8 is selected
    ...
    if (placeXOrO(pickASquare)) {
      //If the random number evaluated returns true, the square hasn's been selected yet.
